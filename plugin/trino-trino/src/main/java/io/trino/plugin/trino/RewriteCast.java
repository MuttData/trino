        ...
        implements ConnectorExpressionRule<Call, ParameterizedExpression>
{
    ...
    public Optional<ParameterizedExpression> rewrite(Call call, Captures captures, RewriteContext<ParameterizedExpression> context)
    {
        ...
        Optional<ParameterizedExpression> translatedExpression = context.defaultRewrite(expression);
        ...
        return Optional.of(new ParameterizedExpression(format("CAST (%s AS %s)", translatedExpression.get().expression(), mappedType.get()), translatedExpression.get().parameters()));
    }
